= quarkus-camel-xml-streaming

This project shows how we can use https://docs.oracle.com/en/java/javase/21/docs/api/java.xml/javax/xml/stream/XMLEventReader.html[`XMLEventReader` (`docs.oracle.com`)] and https://github.com/FasterXML/aalto-xml[`aalto-xml` (`github.com`)].
